...
class _FakeCharacter_3 extends _i1.SmartFake implements _i5.Character {
  _FakeCharacter_3(
    Object parent,
    Invocation parentInvocation,
  ) : super(
...
class MockHouseService extends _i1.Mock implements _i6.HouseService {
  ...
  @override
  _i7.Future<List<_i3.House>> getAll({int? page = 1}) => (super.noSuchMethod(
        Invocation.method(
          #getAll,
          [],
          {#page: page},
        ),
        returnValue: _i7.Future<List<_i3.House>>.value(<_i3.House>[]),
      ) as _i7.Future<List<_i3.House>>);
  @override
  _i7.Future<_i3.House> getForId(int? id) => (super.noSuchMethod(
        Invocation.method(
          #getForId,
          [id],
        ),
        returnValue: _i7.Future<_i3.House>.value(_FakeHouse_1(
          this,
          Invocation.method(
            #getForId,
            [id],
...
class MockCharacterService extends _i1.Mock implements _i8.CharacterService {
  ...
  @override
  _i7.Future<_i5.Character> getForId(int? id) => (super.noSuchMethod(
        Invocation.method(
          #getForId,
          [id],
        ),
        returnValue: _i7.Future<_i5.Character>.value(_FakeCharacter_3(
          this,
          Invocation.method(
            #getForId,
            [id],
