...
class _FakeHouseDto_2 extends _i1.SmartFake implements _i4.HouseDto {
  _FakeHouseDto_2(
    Object parent,
    Invocation parentInvocation,
  ) : super(
...
class _FakeCharacterDto_4 extends _i1.SmartFake implements _i5.CharacterDto {
  _FakeCharacterDto_4(
    Object parent,
    Invocation parentInvocation,
  ) : super(
...
class MockHouseRepository extends _i1.Mock implements _i6.HouseRepository {
  ...
  @override
  _i7.Future<List<_i4.HouseDto>> getAll({required int? page}) =>
      (super.noSuchMethod(
        Invocation.method(
          #getAll,
          [],
        ...
        returnValue: _i7.Future<List<_i4.HouseDto>>.value(<_i4.HouseDto>[]),
      ) as _i7.Future<List<_i4.HouseDto>>);
  @override
  _i7.Future<_i4.HouseDto> getForId(int? id) => (super.noSuchMethod(
        Invocation.method(
          #getForId,
          [id],
        ),
        returnValue: _i7.Future<_i4.HouseDto>.value(_FakeHouseDto_2(
          this,
          Invocation.method(
            #getForId,
            [id],
...
class MockCharacterRepository extends _i1.Mock
  ...
  @override
  _i7.Future<List<_i5.CharacterDto>> getAll({required int? page}) =>
      (super.noSuchMethod(
        Invocation.method(
          #getAll,
          [],
        ...
        returnValue:
            _i7.Future<List<_i5.CharacterDto>>.value(<_i5.CharacterDto>[]),
  ...
  _i7.Future<_i5.CharacterDto> getForId(int? id) => (super.noSuchMethod(
        ...
        returnValue: _i7.Future<_i5.CharacterDto>.value(_FakeCharacterDto_4(
          this,
          Invocation.method(
            #getForId,
            [id],
